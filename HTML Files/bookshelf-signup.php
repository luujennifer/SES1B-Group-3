				...
				<form class="signup" action="../index.php" method="POST">
					...
					<div class="inputFields">
						<div class="floating-label-wrap">
							<input type="text" id="firstName" pattern="[A-Z][a-zA-Z-\s]{1,}" required>
							<label for="firstName" class="floating-label">First Name</label>
						</div>
						<div class="floating-label-wrap">
							<input type="text" id="lastName" pattern="[A-Z][a-zA-Z-]{1,}" required>
						...
						<div class="floating-label-wrap">
							<select id="accType" class="accountDropDown" required>
						...
						<!-- Password group -->
						<div class="floating-label-wrap">
							<input type="password" id="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
